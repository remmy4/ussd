...
<head>
    ...
    <style>
        ...
        button {
            background-color:rgb(113, 213, 249);
            color: white;
            border: none;
            cursor: pointer;
            transition: 0.2s;
        ...
        button:hover {
            background-color:rgb(78, 228, 251);
        }
...
<body>
<div style="background:rgb(17, 60, 77); padding: 1px;color: white;border-radius: 5px 5px 5px 5px;">
...
<h1 style="text-align: center;">Student Appeals Dashboard</h1>
